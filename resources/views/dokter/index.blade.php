                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button onclick="addForm('{{ route('dokter.store') }}')" class="btn btn-sm  btn-success"><i
...
@push('js')
    ...
    <script>
        ...
        function addForm(url) {
            ...
            $('#modal-form .modal-title').text('Tambah Data Dokter');
            $('#modal-form form')[0].reset();
            $('#modal-form form').attr('action', url);
            $('#modal-form [name=_method]').val('post');
            $('#modal-form').on('shown.bs.modal', function() {
                $(this).find('[autofocus]').prop('readonly', false).focus();
            })
        }

        function editForm(url) {
            $('#modal-form').modal('show');
            $('#modal-form .modal-title').text('Edit Data Dokter');
            $('#modal-form form')[0].reset();
            $('#modal-form form').attr('action', url);
            $('#modal-form [name=_method]').val('put');
            $('#modal-form').on('shown.bs.modal', function() {
                $(this).find('[autofocus]').prop('readonly', true).focus();
            })

            $.get(url)
                .done((response) => {
                    $('#modal-form [name=id_dokter]').val(response.id_dokter);
